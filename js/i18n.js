export const UI_TEXT = {
  ja: {
    bodiesTab:'天体',infoTab:'解説',settingsTab:'表示',close:'閉じる',displayHelp:'軌道線とラベルの表示を切り替えます。',touchRotate:'1本指で回転',touchZoom:'ピンチでズーム',touchPan:'2本指で移動',touchHint:'1本指で回転 · ピンチでズーム',
    ...
    planets:'惑星',shownMoon:'表示中の衛星',type:'天体の種類',orbitingPlanets:'まわりの惑星',star:'恒星',selectBody:'天体を選ぶ',bodyCount:'10 天体',rotate:'ドラッグで回転',zoom:'スクロールでズーム',pan:'右ドラッグで移動',tracking:'選択した天体を追従中',speed:'再生速度',orbits:'軌道線',labels:'ラベル',reset:'全体に戻る',resetTitle:'全体に戻る（Esc）',pause:'一時停止',play:'再生',playTitle:'一時停止 / 再生（Space）',speedAria:'再生速度',
  ...
  en: {
    bodiesTab:'Bodies',infoTab:'Info',settingsTab:'Display',close:'Close',displayHelp:'Show or hide orbit lines and labels.',touchRotate:'One finger to orbit',touchZoom:'Pinch to zoom',touchPan:'Two fingers to pan',touchHint:'Drag to orbit · Pinch to zoom',
